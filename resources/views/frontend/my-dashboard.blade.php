					...
					<div class="my_card">
						<div class="row">
							<div class="col-lg-12">
								...
								<p>{{ __('From your account dashboard. you can view your') }} <strong><a href="{{ route('frontend.my-booking') }}">{{ __('recent booking') }}</a></strong>, <strong><a href="{{ route('frontend.my-profile') }}">{{ __('profile') }}</a></strong> {{ __('and') }} <strong><a href="{{ route('frontend.change-password') }}">{{ __('change password') }}</a></strong>.</p>
							</div>
						</div>
					</div>
				</div>
