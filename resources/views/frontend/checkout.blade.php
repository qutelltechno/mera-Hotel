                ...
                <form novalidate="" data-validate="parsley" id="checkout_formid">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            @auth
                            @else
                                <p class="text-black">{{ __('Already have an account?') }} <strong class="text-black"><a
                                            class="text-black"
                        ...
                        <div class="col-lg-5">
                            <div class="sidebar">
                                <div class="widget-card">
                                    <div class="widget-title">{{ __('Mira business') . ' - ' . __('Booking Summary') }}
                                    </div>
                                            ...
                                            <div class="room-book-card">
                                                <div class="room-book-img">
                                                    <a href="{{ route('frontend.room', [$rtdata->id, $rtdata->slug]) }}">
                                                        <img src="{{ asset('public/media/' . $rtdata->thumbnail) }}"
                                                            alt="{{ $rtdata->title }}" />
                                                    </a>
                                                </div>
                                                <div class="room-book-content">
                                                    <div class="room-title">
                                                        <a
                                                            href="{{ route('frontend.room', [$rtdata->id, $rtdata->slug]) }}"><span
                                                                class="text-black">{{ $rtdata->title }}</span> </a>
                                                    </div>
                                                    ...
                                                    <div class="room-price">
                                                        ...
                                                        @if ($rtdata->price != '')
                                                            @if ($gtext['currency_position'] == 'left')
                                                                <div class="new-price">
                                                                    {{ $gtext['currency_icon'] }}{{ NumberFormat($rtdata->price) }}
                                                                </div>
                                                            @else
                                                                <div class="new-price">
                                                                    {{ NumberFormat($rtdata->price) }}{{ $gtext['currency_icon'] }}
                                                                </div>
                                                            @endif
                                                        @endif
                                                        @if ($rtdata->is_discount == 1 && $rtdata->old_price != '')
                                                            @if ($gtext['currency_position'] == 'left')
                                                                <div class="old-price text-black">
                                                                    {{ $gtext['currency_icon'] }}{{ NumberFormat($rtdata->old_price) }}
                                                                </div>
                                                            @else
                                                                <div class="old-price text-black">
                                                                    {{ NumberFormat($rtdata->old_price) }}{{ $gtext['currency_icon'] }}
                                                                </div>
                                                            @endif
                                                        @endif
                                                        @if (glan() === 'en')
                                                    ...
                                                    <ul class="room-meta">
                                                        <li class="text-black">{{ __('Adult') }}
                                                            {{ $rtdata->total_adult }}</li>
                                                        <li class="text-black">{{ __('Child') }}
                                                            {{ $rtdata->total_child }}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb15">
                                                <label for="checkout_date"
                                                    class="form-label">{{ __('Check Out') }}</label>
                                            ...
                                            <div class="col-12 mb15">
                                                <div class="r_extra">
                                                    ...
                                                    @if ($total_room > 0)
                                                        <span class="instock  ">{{ $total_room }}
                                                            {{ __('Room') }}</span>
                                                    @else
                                                        <span class="stockout">{{ $total_room }}
                                                            {{ __('Room') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-12 mb15" id="TotalPrice">
                                                <table class="table total-price-card">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><span
                                                                    class="title text-black">{{ __('Discount') }}</span><span
                                                                    class="price">0</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td><span
                                                                    class="title text-black">{{ __('Total') }}</span><span
                                                                    class="price">0</span></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="col-12">
                                                <input name="roomtype_id" id="roomtype_id" type="hidden"
                                                    value="{{ $rtdata->id }}" />
                                                ...
                                                <a id="checkout_submit_form" href="javascript:void(0);"
                                                    class="btn theme-btn mt10 checkout_btn">{{ __('Send Booking Request') }}</a>
                                    ...
                                    <div class="widget-card">
                                        ...
                                        <div class="widget-body">
                                            ...
                                            @if ($gtext['email_footer'] != '')
                                                <p class="text-black"><strong>{{ __('Email') }}:</strong>
                                                    {{ $gtext['email_footer'] }}</p>
                                            @endif

                                            @if ($gtext['address_footer'] != '')
                                                <p class="mb0 text-black"><strong>{{ __('Address') }}:</strong>
                                                    {{ $gtext['address_footer'] }}</p>
                                            @endif
                                        </div>
                                    </div>
                                @endif
