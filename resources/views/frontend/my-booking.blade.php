                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" style="width:23%">{{ __('In / Out Date') }}
                                                    </th>
                                                    <th class="text-center" style="width:10%">{{ __('Total Room') }}</th>
                                                    <th class="text-center" style="width:15%">{{ __('Payment Status') }}
                                                    </th>
                                                    <th class="text-center" style="width:15%">{{ __('Booking Status') }}
                                                    </th>
                                                ...
                                                @if (count($datalist) > 0)
                                                    @foreach ($datalist as $row)
                                                        <tr>
                                                            <td class="text-left">
                                                                <p><a
                                                                        href="{{ route('frontend.invoice-details', [$row->id, $row->booking_no]) }}">{{ $row->booking_no }}</a>
                                                                </p>
                                                                @if ($row->booking_status_id == 2)
                                                                    <p class="status_card"><span
                                                                            class="in_running"></span>{{ __('Running') }}
                                                                    </p>
                                                                @elseif($row->booking_status_id == 3)
                                                                    <p class="status_card"><span
                                                                            class="in_checked_out"></span>{{ __('Checked Out') }}
                                                                    </p>
                                                                @else
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                <a title="{{ __('Invoice') }}" class="mr10"
                                                                    href="{{ route('frontend.invoice2', [$row->id, $row->booking_no]) }}"><i
                                                                ...
                                                                <a title="{{ __('View') }}"
                                                                    href="{{ route('frontend.invoice-details', [$row->id, $row->booking_no]) }}"><i
                                                                        class="bi bi-eye"></i></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
...
@push('scripts')
    <script type="text/javascript">
        var my_dashbord_href = location.h ref;
