                    ...
                    <div class="card">
                        ...
                        <div id="form-panel" class="card-body dnone">
                            <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="mt-15 mb0"><strong>{{ __('Google reCAPTCHA') }}</strong> (If you are not
                                            yet added Google reCAPTCHA key. <strong><a
                                                    href="{{ route('backend.google-recaptcha') }}">Click
                                                    Here</a></strong>)</p>
                                        <div class="tw_checkbox checkbox_group">
                    ...
                    <div class="modal-content">
                        ...
                        <form novalidate="" data-validate="parsley" id="Element_DataEntry_formId">
                            <div class="modal-body tp-modal-body">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field_label">{{ __('Label') }}<span
                                                        class="red">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field_type">{{ __('Type') }}<span
                                                        class="red">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field_name">{{ __('Name') }}<span
                                                        class="red">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="is_label">{{ __('Label Show/Hide') }}<span
                                                        class="red">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field_mandatory">{{ __('Mandatory') }}<span
                                                        class="red">*</span></label>
                                                <select name="field_mandatory" id="field_mandatory"
                                                    class="chosen-rtl form-control">
                                                    <option value="no">No</option>
                                                    <option value="yes">Yes</option>
                                                </select>
                            ...
                            <div class="modal-footer">
                                <a onclick="onSaveChanges()" href="javascript:void(0);"
                                    class="btn blue-btn">{{ __('Save changes') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
