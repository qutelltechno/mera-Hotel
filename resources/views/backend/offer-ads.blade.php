                        ...
                        <div id="form-panel" class="card-body dnone">
                            <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                                ...
                                <div class="row" hidden>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="offer_ad_type">{{ __('Offer & Ads Position') }}<span
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="offer_ads_image">{{ __('Image') }}<span
                                                    class="red">*</span></label>
                                            <div class="tp-upload-field">
                                                <input type="text" name="image" id="offer_ads_image"
                                            ...
                                            <div id="remove_offer_ads_image" class="select-image">
                                                ...
                                                <a onClick="onMediaImageRemove('offer_ads_image')"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="button_text">{{ __('Category') }}<span
                                                    class="red">*</span></label>
                                            <select name="button_text" id="button_text" class="chosen-rtl form-control">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="target">{{ __('Target Window') }}<span
                                                    class="red">*</span></label>
                                            <select name="target2" id="target" class="chosen-rtl form-control">
