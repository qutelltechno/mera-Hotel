            ...
            @if (count($datalist) > 0)
                @foreach ($datalist as $row)
                    <tr>
                        ...
                        <td class="text-left"><a href="{{ route('backend.menu-builder', [$row->lan, $row->id]) }}"
                                title="{{ __('Customize') }}">{{ $row->menu_name }}</a></td>
                        ...
                        <td class="text-center">
                            <div class="btn-group action-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('backend.menu-builder', [$row->lan, $row->id]) }}"
                                        class="dropdown-item">{{ __('Customize') }}</a>
