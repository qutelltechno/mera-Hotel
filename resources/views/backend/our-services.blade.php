                        ...
                        <div id="form-panel" class="card-body dnone">
                            <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="services_title">{{ __('Title') }}<span
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="description">{{ __('Short Description') }}<span
                                                    class="red">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="services_image">{{ __('Image') }}<span
                                                    class="red">*</span></label>
                                            <div class="tp-upload-field">
                                                <input type="text" name="image" id="services_image"
                                                    class="form-control" readonly>
                                                <a id="on_services_image" href="javascript:void(0);"
                                            ...
                                            <div id="remove_services_image" class="select-image">
                                                ...
                                                <a onClick="onMediaImageRemove('services_image')" class="media-image-remove"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="is_publish" id="is_publish" class="chosen-rtl form-control">
                                                    @foreach ($statuslist as $row)
                                                        <option value="{{ $row->id }}">
                                                            {{ $row->status === 'Publish' ? __('Service 1') : __('Service 2') }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
