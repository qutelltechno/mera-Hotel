                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="slider_type_filter" id="slider_type_filter"
                        ...
                        <div id="form-panel" class="card-body dnone">
                            <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="slider_type">{{ __('Manage Page') }}<span
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="slider_title">{{ __('Title') }}<span
                                                    class="red">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="slider_image">{{ __('Thumbnail Image') }}<span
                                                    class="red">*</span></label>
