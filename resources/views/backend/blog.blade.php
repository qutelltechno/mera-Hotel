                        ...
                        <div id="form-panel" class="card-body dnone">
                            <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="blog_titleen" id="blog_titleen"
                                                class="form-control parsley-validated" data-required="true">
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
                                        <div class="form-group ">
                                            <label style="" for="blog_titlear">العنوان بالعربية <span
                                                    class="red">*</span></label>
                                            <input type="text" name="blog_titlear" id="blog_titlear"
                                                class="form-control parsley-validated" data-required="true">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group tpeditor">
                                            ...
                                            <textarea name="descriptionen" id="descriptionen" class="form-control parsley-validated" data-required="true"
                                                rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group tpeditor">
                                            <label for="descriptionar">الوصف بالعربية <span
                                                    class="red">*</span></label>
                                            <textarea name="descriptionar" id="descriptionar" class="form-control parsley-validated" data-required="true"
                                                rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <em>e.g. Facebook share image. Recommended image size width: 600px and height:
                                                315px.</em>
