...
@section('content')
    ...
    <div class="main-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 mb-5">
                                    <div class="filter-form-group" style="">
                                        ...
                                        <button type="submit" onClick="onFilterAction()"
                                            class="btn btn-theme form-control">{{ __('Filter') }}</button>
                                    </div>
                                </div>
                                <div class="col-lg-4 mb-5">
                                    <div class="form-group search-box  ">
                                        ...
                                        <button style="" type="submit" onClick="onSearch()"
        ...
        @push('scripts')
            ...
            <link rel="stylesheet"
                href="{{ asset('public/backend/bootstrap-datetimepicker/bootstrap-datetimepicker.css') }}">
