                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="page_type_filter" id="page_type_filter"
                                            class="chosen-rtl form-control">
                        ...
                        <div id="form-panel" class="card-body dnone">
                            <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="page_type">{{ __('Manage Page') }}<span
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="welcome_title">{{ __('Welcome Mira') }}<span
                                                    class="red">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="welcom_Description">{{ __('Welcome Description') }}</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="values_title">{{ __('Values') }}<span
                                                    class="red">*</span></label>
                                            <input type="text" name="values_title" id="values_title"
                                                class="form-control parsley-validated" data-required="true">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="values_description">{{ __('Values Description') }}</label>
                                            <textarea name="values_description" id="values_description" class="form-control" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
								{{-- // --}}
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="package_title">{{ __('Perfect Package Of Services') }}<span
                                                    class="red">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label
                                                for="package_description">{{ __('Perfect Package Of Services Description') }}</label>
                                            <textarea name="package_description" id="package_description" class="form-control" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row rcapHideShow">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_customers" id="total_customers"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_amenities" id="total_amenities"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_packages" id="total_packages"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="about_image1">{{ __('Thumbnail Image') }}<span
                                                    class="red">*</span></label>
                                            <div class="tp-upload-field">
                                                <input type="text" name="image" id="about_image1"
                                                    class="form-control" readonly>
                                                <a id="on_about_image1" href="javascript:void(0);"
                                            ...
                                            <div id="remove_about_image1" class="select-image">
                                                ...
                                                <a onClick="onMediaImageRemove('about_image1')" class="media-image-remove"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group image2HideShow">
                                            <label for="about_image2">{{ __('Thumbnail Image') }}
                                                ({{ __('Optional') }})</label>
                                            <div class="tp-upload-field">
                                                <input type="text" name="image2" id="about_image2"
                                                    class="form-control" readonly>
                                                <a id="on_about_image2" href="javascript:void(0);"
                                                    class="tp-upload-btn"><i
                                                        class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                                            </div>
                                            <em id="RecommendedText">Recommended image size width: 900px and height:
                                                700px.</em>
                                            <div id="remove_about_image2" class="select-image">
                                                <div class="inner-image" id="view_about_image2"></div>
                                                <a onClick="onMediaImageRemove('about_image2')" class="media-image-remove"
                                                    href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group image3HideShow">
                                            <label for="about_image3">{{ __('Thumbnail Image') }}
                                                ({{ __('Optional') }})</label>
                                            <div class="tp-upload-field">
                                                <input type="text" name="image3" id="about_image3"
                                                    class="form-control" readonly>
                                                <a id="on_about_image3" href="javascript:void(0);"
                                                    class="tp-upload-btn"><i
                                                        class="fa fa-window-restore"></i>{{ __('Browse') }}</a>
                                            </div>
                                            <em>Recommended image size width: 900px and height: 700px.</em>
                                            <div id="remove_about_image3" class="select-image">
                                                ...
                                                <a onClick="onMediaImageRemove('about_image3')" class="media-image-remove"
                                                    href="javascript:void(0);"><i class="fa fa-remove"></i></a>
                                            </div>
                                        </div>
                                    </div>
