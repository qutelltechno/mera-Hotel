                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-button float-right">
                                            <button type="button" onClick="onExcelExport()"
                                                class="btn btn-theme mb0 btn-padding"><i class="fa fa-download"></i>
                                                {{ __('Excel') }}</button>
                                            <button type="button" onClick="onCSVExport()"
                                                class="btn btn-theme mb0 btn-padding"><i class="fa fa-download"></i>
                                                {{ __('CSV') }}</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="filter-form-group pull-right">
                                            ...
                                            <input name="end_date" id="end_date" type="text" class="form-control"
                                                placeholder="yyyy-mm-dd">
                                            <button type="submit" onClick="onFilterAction()"
                                                class="btn btn-theme">{{ __('Filter') }}</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="container-fluid">
                        <form novalidate="" data-validate="parsley" id="DataEntry_formId">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="booking_status_id">{{ __('Booking Status') }}<span
                                                class="red">*</span></label>
                                        <select name="booking_status_id" id="booking_status_id"
                                            class="chosen-rtl form-control">
                                            @foreach ($booking_status_list as $row)
                                                <option value="{{ $row->id }}">
                                                    {{ $row->bstatus_name }}
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a id="SubmitBookingCheckOutForm" href="javascript:void(0);"
                                        class="btn btn-theme update_btn">{{ __('Update') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
