(function ($) {
    ...
    $(".popup-video").magnificPopup({
        ...
        $(".hero-slider").slick({
            ...
            arrows: true,
            prevArrow:
            '<button type="button" class="slider-prev-button"><i class="bi bi-arrow-left"></i></button>',
            nextArrow:
            '<button type="button" class="slider-next-button"><i class="bi bi-arrow-right"></i></button>',
            responsive: [
                {
                    breakpoint: 1200,
                    settings: {
