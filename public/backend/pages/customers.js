...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/backend/getCustomersTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/backend/getCustomersTableData",
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/backend/getCustomersTableData?search="+search,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/getCustomerById',
		data: 'id='+RecordId,
		success: function (response) {
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/deleteCustomer',
		data: 'id='+RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/bulkActionCustomers',
