...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/super-admin/getPolicyTableData?page="+page,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/super-admin/getPolicyTableData?search="+$("#search").val(),
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/super-admin/savePolicyData',
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/super-admin/getPolicyById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/super-admin/deletePolicy',
		data: 'id='+RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/super-admin/bulkActionPolicy',
