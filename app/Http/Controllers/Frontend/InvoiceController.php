...
//     public function getInvoice2($booking_id, $booking_no)
//     {
//         $gtext = gtext();
...
//         $customerName = $mdata['customer_name'];
//         $customerAddress = $mdata['customer_address'];
//         $customerCity = $mdata['city'];
//         $state = $mdata['state'];
//         $zip_code = $mdata['zip_code'];
//         $country = $mdata['country'];
//         $customer_email = $mdata['customer_email'];
//         $customer_phone = $mdata['customer_phone'];
//         $logo = public_path('media/' . $gtext['front_logo']);

//         $html = view('frontend.invoice-pdf',
//             compact('customerName', 'customerAddress', 'customerCity',
//                 'state', 'zip_code', 'country',
//                 'customer_email', 'customer_phone', 'logo')
//         )->toArabicHTML();
...
//             'invoice-' . $mdata['booking_no'] . time() . ".pdf", // the name of the file/stream
//             $headers
//         );
